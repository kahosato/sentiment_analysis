...
#     return compute_score_document(tokens, compute_neg_dir_dep(tokens, neg_words, nlp), lexicon, bin, stemmed)
#
#
# def flip_dep_obj(tokens, lexicon, neg_words, nlp, bin=True, stemmed=False):
#     return compute_score_document(tokens, compute_neg_head_obj(tokens, neg_words, nlp), lexicon, bin, stemmed)
#
#
